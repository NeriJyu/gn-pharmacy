...
stockRouter.get("/:pharmacyId/:medicineId", async (req, res) => {
  try {
...
stockRouter.patch("/:pharmacyId/:medicineId", async (req, res) => {
  try {
...
stockRouter.delete("/:pharmacyId/:medicineId", async (req, res) => {
  try {
